...
/* harmony import */ var _modules_showContent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showContent */ "./src/js/modules/showContent.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_showContent__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus__content').init();
...
var Difference = /*#__PURE__*/function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(containers, items, counter) {
      containers.querySelector('.plus').addEventListener('click', function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ShowContent; });
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
...
var MiniSlider = /*#__PURE__*/function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, animate, autoplay, paused) {
    ...
    return _super.call(this, container, prev, next, activeClass, animate, autoplay, paused);
  }
  ...
  _createClass(MiniSlider, [{
    ...
    key: "activadAnimation",
    value: function activadAnimation() {
      var _this3 = this;
    ...
    key: "pausedAutoplay",
    value: function pausedAutoplay(trigger) {
      var _this4 = this;

      trigger.parentNode.addEventListener('mouseenter', function () {
        clearInterval(_this4.paused);
      });
    }
  }, {
    key: "startedAutoplay",
    value: function startedAutoplay(trigger) {
      var _this5 = this;

      trigger.parentNode.addEventListener('mouseleave', function () {
        _this5.activadAnimation();
      });
    }
  }, {
    key: "init",
    value: function init() {
      try {
        ...
        this.bindTriggers();
        this.decorizeSlides();
        this.activadAnimation();
        this.pausedAutoplay(this.slides[0]); // this.pausedAutoplay(this.next);
        // this.pausedAutoplay(this.prev);

        this.startedAutoplay(this.slides[0]); // this.startedAutoplay(this.next);
        // this.startedAutoplay(this.prev);
      } catch (e) {}
    }
  }]);
